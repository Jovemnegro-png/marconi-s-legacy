...
function ServicesPage() {
  return <>
    ...
    <section className="closing-section"><div className="site-container closing-inner"><span className="eyebrow">CABELO E BARBA</span><h2>Quer fazer <em>os dois?</em></h2><p>Fale com a equipe para combinar seu atendimento.</p><Button asChild variant="primary" size="premium"><a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer">Conversar pelo WhatsApp <ArrowUpRight aria-hidden="true" /></a></Button></div></section>
  </>;
}